...
#oc new-project gpte-jenkins    --display-name="gpte AdvDev Homework Jenkins"
...
#  oc policy add-role-to-user admin ${USER} -n gpte-jenkins
...
#  oc annotate namespace gpte-jenkins       openshift.io/requester=${USER} --overwrite
